...
<head>
	<meta charset="UTF-8">
	<title>Haptic - Pricing Page</title>
...
<!-- Start of Pricing section
	============================================= -->
	<section id="bi-pricing-3" class="bi-pricing-section-3  pricing-page-content position-relative">
		...
		<div class="container">
			<div class="bi-price-top-content d-flex flex-wrap justify-content-between align-items-end">
				<div class="bi-section-title-1 headline">
