...
<!-- Start of Faq feed section
	============================================= -->
	<section id="bi-faq-feed" class="bi-faq-feed-section inner-page-padding">
		<div class="container">
			...
			<div class="bi-faq-feed-content">
				<div class="row">
					<div class="col-lg-5">
						<div class="bi-faq-feed-img">
							<img src="assets/img/about/ff.png" alt="">
						</div>
					</div>
					<div class="col-lg-7">
						<div class="bi-faq-feed-accordion">
			...
			<div class="bi-team-details-contact-info headline pera-content">
				<div class="bi-team-details-contact-title text-center">
					<h3>Contact Me</h3>
