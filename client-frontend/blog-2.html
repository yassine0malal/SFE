...
<!-- Start of Blog feed section
	============================================= -->
	<section id="bi-blog-feed-2" class="bi-blog-feed-section-2 inner-page-padding">
		<div class="container">
			...
			<div class="bi-blog-feed-content-2">
				<div class="container">
					<div class="row justify-content-center">
						<div class="col-lg-4 col-md-6">
							<div class="bi-blog-feed-item-2">
								<div class="blog-img position-relative">
									<img src="assets/img/blog/bfd1.png" alt="">
								...
								<div class="blog-text headline pera-content">
									<h3><a href="#">UX Checklists for Interface Designers</a></h3>
						...
						<div class="col-lg-4 col-md-6">
							<div class="bi-blog-feed-item-2">
								<div class="blog-img position-relative">
									<img src="assets/img/blog/bfd2.png" alt="">
									<div class="blog-meta text-uppercase position-absolute">
										<i class="fas fa-calendar-alt"></i> October 6, 2023
									</div>
								</div>
								<div class="blog-text headline pera-content">
									<h3><a href="#">Working Together, ideas Come to Life</a></h3>
									<p>No matter how big your company is, as you expand and reach new highs you’ll want an agency</p>
								</div>
							</div>
						</div>
						<div class="col-lg-4 col-md-6">
							<div class="bi-blog-feed-item-2">
								<div class="blog-img position-relative">
									<img src="assets/img/blog/bfd3.png" alt="">
									<div class="blog-meta text-uppercase position-absolute">
										<i class="fas fa-calendar-alt"></i> October 6, 2023
									</div>
								</div>
						...
						<div class="col-lg-4 col-md-6">
							<div class="bi-blog-feed-item-2">
								<div class="blog-img position-relative">
									<img src="assets/img/blog/bfd4.png" alt="">
									<div class="blog-meta text-uppercase position-absolute">
										<i class="fas fa-calendar-alt"></i> October 6, 2023
									</div>
								</div>
								<div class="blog-text headline pera-content">
									<h3><a href="#">A Designer’s UI/UX Complete Checklist.</a></h3>
									<p>No matter how big your company is, as you expand and reach new highs you’ll want an agency</p>
								</div>
							</div>
						</div>
						<div class="col-lg-4 col-md-6">
							<div class="bi-blog-feed-item-2">
								<div class="blog-img position-relative">
									<img src="assets/img/blog/bfd5.png" alt="">
									<div class="blog-meta text-uppercase position-absolute">
										<i class="fas fa-calendar-alt"></i> October 6, 2023
									</div>
								</div>
								<div class="blog-text headline pera-content">
									<h3><a href="#">Basic Rule Running Web Agency Business</a></h3>
									<p>No matter how big your company is, as you expand and reach new highs you’ll want an agency</p>
								</div>
							</div>
						</div>
						<div class="col-lg-4 col-md-6">
							<div class="bi-blog-feed-item-2">
								<div class="blog-img position-relative">
									<img src="assets/img/blog/bfd6.png" alt="">
									<div class="blog-meta text-uppercase position-absolute">
										<i class="fas fa-calendar-alt"></i> October 6, 2023
									</div>
								</div>
						...
						<div class="col-lg-4 col-md-6">
							<div class="bi-blog-feed-item-2">
								<div class="blog-img position-relative">
									<img src="assets/img/blog/bfd7.png" alt="">
									<div class="blog-meta text-uppercase position-absolute">
										<i class="fas fa-calendar-alt"></i> October 6, 2023
									</div>
								</div>
								<div class="blog-text headline pera-content">
									<h3><a href="#">Ten Ways of Lying Your Relationship</a></h3>
									<p>No matter how big your company is, as you expand and reach new highs you’ll want an agency</p>
								</div>
							</div>
						</div>
						<div class="col-lg-4 col-md-6">
							<div class="bi-blog-feed-item-2">
								<div class="blog-img position-relative">
									<img src="assets/img/blog/bfd8.png" alt="">
									<div class="blog-meta text-uppercase position-absolute">
										<i class="fas fa-calendar-alt"></i> October 6, 2023
									</div>
								</div>
								<div class="blog-text headline pera-content">
									<h3><a href="#">How to Manage a Talented Design Team</a></h3>
									<p>No matter how big your company is, as you expand and reach new highs you’ll want an agency</p>
								</div>
							</div>
						</div>
						<div class="col-lg-4 col-md-6">
							<div class="bi-blog-feed-item-2">
								<div class="blog-img position-relative">
									<img src="assets/img/blog/bfd9.png" alt="">
									<div class="blog-meta text-uppercase position-absolute">
										<i class="fas fa-calendar-alt"></i> October 6, 2023
									</div>
								</div>
