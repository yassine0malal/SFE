...
<head>
	<meta charset="UTF-8">
	<title>Haptic - Testimonial</title>
...
<!-- Start of testimonial feed section
	============================================= -->
	<section id="bi-testimonial-feed" class="bi-testimonial-feed-section inner-page-padding">
		<div class="container">
			...
			<div class="bi-testimonial-feed-content">
				<div class="row justify-content-center">
					<div class="col-lg-4 col-md-6">
						<div class="bi-testimonial-feed-item">
							<div class="testimonial-ratting ul-li">
								<ul>
							...
							<div class="testimonial-desc">
								“Excellent UI/Ux Design. She literally transformed my App into a wonderful piece of art. She's got awesome Ui design skills. - Hard
								working Dedicated Great Communi-cation Skills”
							</div>
